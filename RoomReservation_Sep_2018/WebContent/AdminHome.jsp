...
<body bgcolor="white">
<%@page import="Beans.EmployeeBean,DatabaseFiles.EmployeeDatabase,java.util.*"%>
	...
	<ul>
		...
		<center>
		<h1>Employee Detail's</h1>
		
		<%  
			List <EmployeeBean> list = EmployeeDatabase.getAllEmployees();
		...
		<table border="1px solid black">
			...
			<td>${d.getPassword()}</td>
			<td>${d.getRemarks()}</td>
			<td><a href="SDeleteEmployee?eid=${d.getEid()}">Delete</a></td> 		
 			</tr>  
			</c:forEach>  	
		</table>
		</center>
